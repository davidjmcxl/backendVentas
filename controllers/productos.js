    ...
    if (!req.files || Object.keys(req.files).length === 0) {
      ...
      // procesar imagen
        ...
        file.mv(path, (err)=> {
           ...
           conexion.query(`INSERT INTO producto(proveedor,descripcion,precio,existencia,usuario_id,imagen) values('${proveedor}','${descripcion}','${precio}','${existencia}','${usuario_id}','${nombreArchivo}')`, async(error) => {
                if (error) {
